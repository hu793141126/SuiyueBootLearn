        ...
        <div id="search_box">
            ...
            <div id="search_body" style="float: left; padding-bottom: 10px;">
                <div class="search_info">
                    <span>部门ID</span>
                    <select id="idQ" class="selectpicker" data-live-search="true">
                        <option value="0">请选择</option>
                    </select>
                </div>
                <div class="search_info">
                    <span>上级部门ID</span>
                    <select id="parentIdQ" class="selectpicker" data-live-search="true">
                        <option value="0">请选择</option>
                    </select>
                </div>
                <div class="search_info">
                    <span>部门名称</span>
                    <select id="nameQ" class="selectpicker" data-live-search="true">
                        <option value="0">请选择</option>
                    </select>
                </div>
                <div class="search_info">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="float: left; ">
                <form id="applyForm">
                    <div class="search_info">
                        <span>部门ID：</span>
                        <input type="text" id="idA" name="id" class="form-control"
                               placeholder="请输入">
                    </div>
                    <div class="search_info">
                        <span>上级部门ID：</span>
                        <input type="text" id="parentIdA" name="parentId" class="form-control"
                               placeholder="请输入">
                    </div>
                    <div class="search_info">
                        <span>部门名称：</span>
                        <input type="text" id="nameA" name="name" class="form-control"
                               placeholder="请输入">
                    </div>
                    <div class="search_info">
                        <span>创建时间：</span>
    ...
    <div class="modal-dialog" style="height: 520px">
        <div class="modal-content">
            ...
            <div class="modal-body" style="float: left; ">
                <div class="search_info">
                    <span>部门ID：</span>
                    <input type="text" id="idU" name="id" class="form-control"
                           placeholder="请输入">
                </div>
                <div class="search_info">
                    <span>上级部门ID：</span>
                    <input type="text" id="parentIdU" name="parentId" class="form-control"
                           placeholder="请输入">
                </div>
                <div class="search_info">
                    <span>部门名称：</span>
                    <input type="text" id="nameU" name="name" class="form-control"
                           placeholder="请输入">
                </div>
                <div class="search_info">
                    <span>创建时间：</span>
...
<script type="text/javascript">
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#tb_customer').bootstrapTable({
                url: '<%=path%>/dept/list.action',         //请求后台的URL（*）
    ...
    $('#save_btn').click(function () {
        var id = $('#idA').val();
            if (id == "") {
                layer.msg('请输入id', {time: 1500});//提示信息
                return;
            }
        var parentId = $('#parentIdA').val();
            if (parentId == "") {
                layer.msg('请输入parentId', {time: 1500});//提示信息
                return;
            }
        var name = $('#nameA').val();
            if (name == "") {
                layer.msg('请输入name', {time: 1500});//提示信息
                return;
            }
